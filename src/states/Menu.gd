...
func _ready() -> void:
	main_menu.connect("change_menu",Callable(self,"show_menu"))
	credits_menu.connect("change_menu",Callable(self,"show_menu"))
	lobby.connect("change_menu",Callable(self,"show_menu"))
